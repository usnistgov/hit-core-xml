...
public abstract class XMLValidationReportGenerator extends ValidationReportGenerator {
  ...
  public XMLValidationReportGenerator() {
    try {
      css = IOUtils.toString(XMLValidationReportGenerator.class.getResourceAsStream(CSS));
    } catch (IOException e) {
  ...
  public String getHtmlConversionXslt() {
    try {
      return IOUtils.toString(XMLValidationReportGenerator.class.getResourceAsStream(HTML_XSL));
    } catch (IOException e) {
      throw new ValidationReportException(e.getMessage());
    }
  }
